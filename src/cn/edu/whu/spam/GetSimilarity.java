...

{
 ...
 public static void main(String[] args){
	 GetSimilarity nrgram=new GetSimilarity();
	double sim =nrgram.getSimilarity("我在#魔幻精灵#中居然抓到了稀有的'小钉螺'，太不可思议了！你们快来祝贺我吧.@魔幻精灵游戏", "我在#魔幻精灵#中居然抓到了稀有的'卷毛草'，太不可思议了！你们快来祝贺我吧.@魔幻精灵游戏 ",2);
    ...
    public GetSimilarity(String str1,String str2, int n)
    {
